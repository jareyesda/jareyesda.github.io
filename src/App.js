...
function App() {
  return (
    <div class="content-width-extra-large home-container">
      <div>
        <h1 class="display-heading-2 display-inline-block">
        Hi, I'm Juan 👋🏻
        </h1>
      </div>
      <div>
        <h3>
          a software developer @ <a href="https://www.inspiringapps.com/" target="_blank">InspiringApps</a>
        </h3>
      </div>
      <div class="section wf-section">
        <div class="container grid-container">
          <div class="w-layout-grid-fullscreen-section-content">
            <div class="panel bg-gradient-7">
              <div class="panel-body panel-body-large align-content-center rounded purposepadding">
                <div class="center-content">
                  <div class="content-width-large mobiletext">
                    <h1 class="heading-3">
                      About me
                    </h1>
